// /screens/DriverArrived.tsx

import React from 'react';
import { View, Text, StyleSheet, TouchableOpacity, ScrollView } from 'react-native';
import { SafeAreaView } from 'react-native-safe-area-context';
import { Ionicons } from '@expo/vector-icons';
import { DriverArrivedScreenProps } from '../../types/navigation';

export default function DriverArrived({ navigation }: DriverArrivedScreenProps) {
  const code = '7593';
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.bookingCard}>
          ...
          <View style={styles.codeContainer}>
            {code.split('').map((digit, index) => (
              <View key={index} style={[styles.codeDigit, index < code.length - 1 && { marginRight: 12 }]}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('InTripMap')}
        >
